...
const RAW: PersonRaw[] = [
  { name: '이성형', entries: [
    ...
    ['4.12', 'Rider', '기획서 리뷰'], ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
  ]},
  ...
  { name: '우영제', entries: [
    ...
    ['4.12', 'OP Tool', '기획서 리뷰'], ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
  ]},
  ...
  { name: '이경근', entries: [
    ...
    ['4.12', 'Taxi', '기획서 리뷰'], ['4.12', 'Taxi', 'Test Case 작성'], ['4.12', 'Taxi', 'Test Case 작성'],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
  ]},
  { name: '이윤석', entries: [
    ...
    ['4.12', 'Driver/Vehicle', '기획서 리뷰'], ['4.12', 'Driver/Vehicle', 'Test Case 작성'], ['4.12', 'Driver/Vehicle', 'Test Case 작성'],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
  ]},
