...
const RAW: PersonRaw[] = [
  { name: '이성형', entries: [
    ...
    ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''],
  ]},
  { name: '이형찬', entries: [
    ...
    ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''],
  ]},
  { name: '모건', entries: [
  ...
  { name: '이경근', entries: [
    ...
    ['4.12', 'Taxi', '기획서 리뷰'], ['4.12', 'Taxi', 'Test Case 작성'], ['4.12', 'Taxi', 'Test Case 작성'], ['4.12', 'Taxi', 'Test Case 작성'], ['4.12', 'Taxi', 'Test Case 작성'],
    ['4.12', 'Taxi', 'Test Case 작성'], ['4.12', 'Taxi', 'Test Case 작성'], ['4.12', 'Taxi', 'Test Case 작성'], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''],
  ]},
  { name: '이윤석', entries: [
    ...
    ['4.12', 'Driver/Vehicle', 'Test Case 작성'], ['4.12', 'Driver/Vehicle', 'Test Case 작성'], ['4.12', 'Driver/Vehicle', 'Test Case 작성'], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''], ['', '', ''],
    ['', '', ''], ['', '', ''], ['', '', ''],
  ]},
  { name: '심명섭', entries: [
