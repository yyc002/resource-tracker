...
const RAW: PersonRaw[] = [
  ...
  { name: '우영제', entries: [
    ...
    ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'],
    ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['휴무', '', ''], ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'],
    ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['', '', ''],
  ]},
  { name: '성명철', entries: [
    ...
    ['4.12', 'Rider', '기획서 리뷰'], ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'],
    ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'],
    ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'], ['', '', ''], ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'],
    ['4.12', 'Rider', 'Test Case 작성'], ['4.12', 'Rider', 'Test Case 작성'], ['', '', ''],
  ]},
  { name: '조정호', entries: [
    ['4.11', 'OP Tool', 'TC 현행화'], ['4.12', 'OP Tool', '기획서 리뷰'], ['4.12', 'OP Tool', '기획서 리뷰'],
    ['휴무', '', ''], ['휴무', '', ''], ['휴무', '', ''], ['휴무', '', ''], ['휴무', '', ''],
    ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'],
    ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['', '', ''], ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'],
    ['4.12', 'OP Tool', 'Test Case 작성'], ['4.12', 'OP Tool', 'Test Case 작성'], ['', '', ''],
  ]},
  { name: '손윤수', entries: [
    ['4.11', 'OP Tool', 'TC 현행화'], ['4.12', 'OP Tool', '기획서 리뷰'], ['4.12', 'OP Tool', '기획서 리뷰'],
  ...
  { name: '이경근', entries: [
    ...
    ['4.12', 'Driver/Vehicle', 'Test Case 작성'], ['4.12', 'Driver/Vehicle', 'Test Case 작성'], ['', '', ''], ['4.12', 'Driver/Vehicle', 'Test Case 작성'], ['4.12', 'Driver/Vehicle', 'Test Case 작성'],
