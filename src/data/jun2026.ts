...
const RAW: PersonRaw[] = [
  ...
  { name: '이형찬', entries: [
    ...
    ['4.11', 'OP Tool', 'BAT 진행'], ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', '잔여 이슈 정리'], ['4.11', 'OP Tool', 'TC 현행화'], ['', '', ''],
    ['', '', ''], ['', '', ''],
  ]},
  { name: '모건', entries: [
    ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'],
    ...
    ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'],
    ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', 'BAT 진행'],
    ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', '잔여 이슈 정리'], ['4.11', 'Rider', 'TC 현행화'], ['', '', ''],
    ['', '', ''], ['', '', ''],
  ]},
  { name: '박건욱', entries: [
    ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'],
  ...
  { name: '권오성', entries: [
    ...
    ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'],
    ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', 'BAT 진행'],
    ['휴무', '', ''], ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', '잔여 이슈 정리'], ['4.11', 'Rider', 'TC 현행화'], ['', '', ''],
    ['', '', ''], ['', '', ''],
  ]},
  { name: '우영제', entries: [
    ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'],
    ...
    ['지쿠 필드 테스트', '', ''], ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', '잔여 이슈 정리'], ['4.11', 'Rider', 'TC 현행화'], ['', '', ''],
    ['', '', ''], ['', '', ''],
  ]},
  { name: '성명철', entries: [
    ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'],
    ...
    ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'],
    ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'TC 진행'], ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', 'BAT 진행'],
    ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', '잔여 이슈 정리'], ['4.11', 'Driver/Vehicle', 'TC 현행화'], ['', '', ''],
    ['', '', ''], ['', '', ''],
  ]},
  { name: '조정호', entries: [
    ['4.11', 'OP Tool', 'TC 진행'], ['4.11', 'OP Tool', 'TC 진행'],
  ...
  { name: '이경근', entries: [
    ...
    ['4.11', 'Taxi', 'BAT 진행'], ['4.11', 'Taxi', 'BAT 진행'], ['4.11', 'Rider', '잔여 이슈 정리'], ['4.11', 'Rider', 'TC 현행화'], ['', '', ''],
    ['', '', ''], ['', '', ''],
  ]},
  { name: '이윤석', entries: [
    ...
    ['지쿠 필드 테스트', '', ''], ['4.11', 'Taxi', 'BAT 진행'], ['지쿠 필드 테스트', '', ''], ['4.11', 'Taxi', 'BAT 진행'], ['', '', ''],
    ['', '', ''], ['', '', ''],
  ]},
  { name: '심명섭', entries: [
    ...
    ['4.11', 'Driver/Vehicle', 'BAT 진행'], ['4.11', 'Rider', 'BAT 진행'], ['4.11', 'Rider', '잔여 이슈 정리'], ['4.11', 'Driver/Vehicle', 'TC 현행화'], ['', '', ''],
    ['', '', ''], ['', '', ''],
  ]},
]
